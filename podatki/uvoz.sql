COPY drzava FROM 'C:\Users\Uporabnik\Desktop\FAKS\3.letnik\Osnove podatkovnih baz\opb-projekt-main\opb-projekt-main\opb-projekt\Drzave' DELIMITER ';' CSV HEADER;


INSERT INTO drzava (ime, kratica) VALUES
    ('Afghanistan', 'AFG'),
    ('Aland Islands', 'ALA'),
    ('Albania', 'ALB'),
    ('Algeria', 'DZA'),
...
INSERT INTO drzava (ime, kratica)
VALUES
  ('Eswatini', 'SWZ'),
  ('Ethiopia', 'ETH'),
